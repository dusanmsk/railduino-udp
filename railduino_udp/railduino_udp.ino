...
String configurationCommandTemplate;
String pingCommandTemplate;
...
void setup() {
 ...
 /* COMMON settings */
  ...
  configurationCommandTemplate = "rail" + boardAddressStr + " cfg";
  pingCommandTemplate = "rail" + boardAddressStr + " ping";
...
void processConfigurationCommand(String cmd) {
    String tmp = cmd.substring(configurationCommandTemplate.length());
}
...
void processCommands() {
    ...
    if(cmd != "") {
      if(cmd.startsWith(configurationCommandTemplate)) {
        processConfigurationCommand(cmd);
      } else if(cmd.startsWith(pingCommandTemplate)) {
